...
$Form1_1 = GUICreate("QA Test Tools", 615, 338, 1213, 496)
...
Global $GWT	= GUICtrlCreateButton("GW_test", 115, 50, 75, 20)
...
Global $exit = GUICtrlCreateButton("Close", 170, 300, 75, 25)
...
While 1
	...
	Switch $nMsg
		...
		case $gLogB
			run ('explorer \\sqa-ws-b\c$\GwsFolders\ServiceQAGateWayLogs\', '')
