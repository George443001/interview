...
sleep (500)
send ("field.bat{enter}")
send ("e:{enter}cd e:\track\field\live\{enter}appl_stop ask=no wait=no{enter}")
ProcessWaitClose("xtime.exe")
ProcessClose ("xcli.exe")
WinActivate("C:\Windows\SYSTEM32\cmd.exe")
WinActive ("C:\Windows\SYSTEM32\cmd.exe")
; send ("taskkill /IM xcli*")
EndFunc
